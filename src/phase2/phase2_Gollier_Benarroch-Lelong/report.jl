...
# ╔═╡ 500c8979-3485-4e9a-a627-b5303ef5032c
using Plots

# ╔═╡ b66a857c-7ff8-11ef-05b8-35ee25447d73
md"""
...
# ╔═╡ 57e66dee-e5d7-4156-9629-b294fb7773f5
md"""
### Réimport des structures précédentes
"""

# ╔═╡ 804b11a4-f2f0-445f-86fd-d99a44d538ff
"""Type abstrait dont d'autres types de noeuds dériveront."""
abstract type AbstractNode{T} end

# ╔═╡ eeec7416-e476-42e5-97bf-32b7fa654b35
...
# ╔═╡ 0e5e9f20-5f2f-4e13-aaf9-08beb48c643b
"""Type abstrait dont d'autres types d'arêtes dériveront."""
abstract type AbstractEdge{U} end

# ╔═╡ e614c5f7-e513-4cf3-9c31-b1e3d59f5869
begin
...
# ╔═╡ 8107c403-a461-4c8c-a9fb-f5872434e86b
begin
...
# ╔═╡ 8c3b7e68-ad35-43c7-9356-429807cd7a52
"""
...
# ╔═╡ 2d30c3d5-38a7-47c7-8240-4eafd7cdd224
"""
...
# ╔═╡ 098459e6-9faa-4359-a6cc-d02d40718281
"""
...
# ╔═╡ 2c1c06f5-e7e0-4178-89f2-14d2ba5409ff
"""
...
# ╔═╡ a7ebeaba-28a7-4cc9-b3a7-6171ebeb4de0
"""
...
# ╔═╡ cdbc9b61-8262-4934-8751-4b1db405bc0b
...
# ╔═╡ 8f58cb9e-095e-4280-b7fa-eefe489ed1f3
...
# ╔═╡ fc6921de-6020-4923-927c-5d89e12e4c48
"""Fonction de commodité qui lit un fichier stsp et trace le graphe."""
function plot_graph(filename::String, label_type::String="number")
  graph = read_stsp(filename)
  plot_graph(graph, label_type)
end

# ╔═╡ be167420-ee75-4476-a094-75ed87fbc1b3
md"""
### Composantes connexes : structure de données

Nous choisissons la structure d'arbre pour représenter les composantes connexes d'un graphe. Notons que cela est restrictif : une composante connexe n'est pas nécessairement acyclique. Cependant, en vue d'une implémentation de l'algorithme de Kruskal, cette structure semble la plus pertinente.

Nous définissons une forêt comme un ensemble d'arbres.
"""

# ╔═╡ a6c852e4-0707-44f3-afb8-547f9c56399d
...
# ╔═╡ c31cc3e3-1a39-4683-bb7b-53c48a62ad41
begin
...
# ╔═╡ 059fb9ae-2092-4b4b-9488-a0b5456226c8
md"""
### Utilitaires nécessaires à l'algorithme de Kruskal
"""

# ╔═╡ 9134c251-affc-4af0-ad0f-08eb4973a952
"""
	find(forest, node_id)
...
"7"
# Le noeud d'identifiant "24" est contenu dans l'arbre de la forêt dont la racine est d'identifiant "7".
```
"""
...
# ╔═╡ 413c4579-50c9-4187-8207-3acdae02578a
"""
...
# ╔═╡ 9630c264-2633-4e2e-be6c-0e99bd22a283
md"""
### Implémentation de l'algorithme de Kruskal
"""

# ╔═╡ 34acb7f7-7565-4f53-b293-31484788a4f0
"""
	kruskal(G)
...
# ╔═╡ 8366c855-c504-4377-8f0c-ab236ee6b53c
md"""
Test de l'algorithme sur l'exemple des notes de cours
"""

# ╔═╡ 80aec461-54c5-4c74-81ae-613e558f8bab
nodes = [
	Node("a", [-2, 0]),
	Node("b", [-1, 1]),
	Node("c", [0, 1]),
...
# ╔═╡ e0a6244a-6419-4b46-81ec-ccd6d019549a
edges = [
	Edge("a", "b", 4),
	Edge("a", "h", 8),
	Edge("b", "c", 8),
...
# ╔═╡ 8b3d0504-342d-4bd3-89d7-9855f347c89f
example_graph = Graph("example", nodes, edges)

# ╔═╡ 5973fa17-a1b7-4163-b244-65d14561958c
example_kruskal = kruskal(example_graph)

# ╔═╡ e421a100-2d47-40c5-996d-69488a738312
graph_kruskal = Graph("Example after Kruskal", nodes, example_kruskal[2])

# ╔═╡ 028ff9d7-3c28-4140-abb4-b97ff687e910
plot_graph(graph_kruskal, "alph")

# ╔═╡ a06aecc6-14e9-41ef-8d08-d22158362396
md"""
### Tests sur des instances de STSP
"""

# ╔═╡ f406be0c-4e90-4049-9eb4-28332d969e42
dantzig42 = read_stsp("/Users/sacha/dev/optim/mth6412b-starter-code/instances/stsp/dantzig42.tsp")

# ╔═╡ b679b137-04b5-4ff7-93df-7208e0f3d623
d42_kruskal = kruskal(dantzig42)

# ╔═╡ 5c1c1ee8-9f36-41c2-8e73-7a00789d9347
plot_graph(Graph("d42_kruskal", collect(values(dantzig42.nodes)), d42_kruskal[2]))

# ╔═╡ ac595a9c-0b26-4b15-af09-7065b06903ae
gr120 = read_stsp("/Users/sacha/dev/optim/mth6412b-starter-code/instances/stsp/gr120.tsp")

# ╔═╡ 3bda9b43-b43f-4a58-add5-2a64deb36381
g120_kruskal = kruskal(gr120)

# ╔═╡ 4e77fb9b-9a86-41c3-af97-d6eaebb3fdb5
plot_graph(Graph("g120_kruskal", collect(values(gr120.nodes)), g120_kruskal[2]))

# ╔═╡ 182ac3b8-f275-4fa1-9619-fa0e735a84c9
md"""
